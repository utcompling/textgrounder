...
# (generated by extract.py from the original file "full_text.txt" in the
# Geotext corpus of Eisenstein et al. 2010) and converts it to "LDA" format,
# splitting it into train/dev/test files in the process.  These files are
# then used by twitter_geotext_process.py.
#
