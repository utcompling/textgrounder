...
public class TRGazetteerMinimized extends TRGazetteer {
    ...
    public TRGazetteerMinimized(String location) {
    }

    public TRGazetteerMinimized(String location, boolean gazetteerRefresh) {
    }
    ...
    protected void initialize(String location) throws FileNotFoundException,
        ...
        System.out.println("Populating minimized TR-Gazetteer from " + location + " ...");
