 ...
 * a file of raw text. First it looks for potential toponyms (possibly-multiword
 * sequences of capitalized words) and then looks each one up in the gazetteer
 * to determine if it's really a place name.
 * 
