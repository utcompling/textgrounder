...
class ParseAndUniquifyTweets(Opts: ProcessTwitterPullParams)
...
object ParseAndUniquifyTweets {
  def apply(Opts: ProcessTwitterPullParams, lines: DList[String]) = {
...
class GroupTweetsAndSelectGood(Opts: ProcessTwitterPullParams)
    extends ProcessTwitterPullShared(Opts) {
  /**
...
object GroupTweetsAndSelectGood {
  def apply(Opts: ProcessTwitterPullParams, lines2: DList[String]) = {
...
class TokenizeFilterAndCountTweets(Opts: ProcessTwitterPullParams)
    extends ProcessTwitterPullShared(Opts) {
...
object TokenizeFilterAndCountTweets {
  def apply(Opts: ProcessTwitterPullParams, lines_cp: DList[String]) = {
...
class ProcessTwitterPullShared(Opts: ProcessTwitterPullParams) {
