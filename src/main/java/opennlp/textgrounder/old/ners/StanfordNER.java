...
import opennlp.textgrounder.old.textstructs.CorpusDocument;
import opennlp.textgrounder.old.textstructs.Token;
...
public class StanfordNER extends NamedEntityRecognizer {
    ...
    public void processText(CorpusDocument doc, String text) {
        ...
        Lexicon<String> lexicon = doc.getCorpus().getLexicon();
