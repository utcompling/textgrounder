 ...
 */
public abstract class SphericalGlobalToInternalInputReader extends SphericalInputReader {

    /**
     * 
     * @param _experimentParameters
     */
    public SphericalGlobalToInternalInputReader(ExperimentParameters _experimentParameters) {
